...
const SearchBar = () => {
  ...
  return (
    <div className="w-full flex flex-col items-center justify-around px-2 mt-5">
      ...
      <form
        className="flex items-center bg-primary justify-between rounded-3xl h-12 w-full"
        style={{ maxWidth: "35em" }}
      >
        ...
        <button
          type="submit"
          className="mr-2 h-full px-5 rounded-full text-secondary-foreground bg-secondary"
          onClick={(e) => search(e)}
        >
          جستجو
        </button>
